...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        for action in legal:
            ...
            dist = self.distancer.getDistance(min_pos, newPos)
            current_dist = self.distancer.getDistance(min_pos, pacmanPosition)
            if dist < current_dist:return action
